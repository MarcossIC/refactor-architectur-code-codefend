...
const topCountriesOnListSet = new Set([
  "Saudi Arabia",
  "Qatar",
...
const countriesToUse = [
  ...Array.from(topCountriesOnListSet).flatMap((country) => [
    mapCountry(country),
  ]),
  ...defaultCountries.flatMap((country) =>
    !topCountriesOnListSet.has(country.name) ? [mapCountry(country)] : []
  ),
];

export const countries = countriesToUse;
