...
import { formatDate } from "src/app/data";
        ...
        <div className="rows">
          {formatIssues().map((vulnerability) => (
            <>
              ...
              >
                <div className="date">{formatDate(vulnerability.creacion)}</div>
                <div className="username">
                  {vulnerability.researcher_username}
                </div>
                <div className="vul-class">{vulnerability.resource_class}</div>
                <div className="vul-risk">{vulnerability.risk_level}</div>
                <div className="vul-score flex no-border-bottom">
                  <span className="risk-score">{vulnerability.risk_score}</span>
                  <span className="space"></span>
                  {generateVulnerabilityArray(vulnerability.risk_score).map(
                    () => (
                      <>
                  ...
                  {generateLimitedArray(vulnerability.risk_score).map(() => (
                    <>
